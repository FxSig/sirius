...
public enum MessageProtocol
{
    ...
    LASER_SCANNER_COMPENSATE_3X3 = 460, //제어->레이저; 스캐너 필드 보정을 위한 가로세로 격자 마킹
    LASER_SCANNER_COMPENSATE_5X5, //5x5
    LASER_SCANNER_COMPENSATE_7X7,
    LASER_SCANNER_COMPENSATE_9X9,
    LASER_SCANNER_COMPENSATE_11X11, //11x11
    LASER_SCANNER_COMPENSATE_13X13,
    LASER_SCANNER_COMPENSATE_15X15,
    LASER_SCANNER_COMPENSATE_17X17, //17x17
