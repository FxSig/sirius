 ...
 * 
 * Changed) 현재 버전에서는 편집기에서 자동으로 펜 집합 기능이 활성화 되어 있어, 약 10여개의 미리 생성된 펜 집합을 제공해 줍니다.
...
namespace SpiralLab.Sirius
{
    class Program2
    {
        ...
        static void Main2(string[] args)
        {
            ...
            rtc.Initialize(kfactor, LaserMode.Yag5, correctionFile);    //default correction file
