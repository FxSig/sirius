...
namespace SpiralLab.Sirius
{
    class Program2
    {
        static SiriusTextSerial serial = new SiriusTextSerial();
        static SiriusTextDate date = new SiriusTextDate();
        static SiriusTextTime time = new SiriusTextTime();
        ...
        private static bool MarkToTime(ILaser laser, IRtc rtc)
        {
            ...
            time.Width = 3.0f;
            time.CapHeight = 3.0f;
            time.LetterSpacing = 0.2f;
            time.WordSpacing = 2.0f;
            time.Align = Alignment.LeftMiddle;
            time.LetterSpace = LetterSpaceWay.Fixed;
