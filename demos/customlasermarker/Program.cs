...
namespace SpiralLab.Sirius
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            #region initialize Laser (custom)
            // virtual laser source with max 20W power (최대 출력 20W 의 가상 레이저 소스 생성)
            var laser = new YourCustomLaser(0, "Custom1", 20);
            //var laser = new YourCustomLaser2(0, "Custom2", 20);
            //var laser = new YourCustomLaser3(0, "Custom3", 20);
        ...
        private static bool MarkByMarker(IRtc rtc, ILaser laser, IMarker marker, IMotor motor)
        {
            ...
            doc.Layers[0].ZMode = ZPositionMode.Absolute;
