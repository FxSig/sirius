...
namespace SpiralLab.Sirius
{
    public partial class MainForm : Form
    {
        ...
        {
            var fileName = Path.Combine( AppDomain.CurrentDomain.BaseDirectory, "recipes", "barcode_offset.sirius");
            this.Open(fileName);
        }
        ...
        public bool Ready()
        {
            ...
            //target entity name
            arg.OffsetAndTextDataTargetEntityName = "DataMatrix1";
            //create list of offset and text data
            arg.Offsets.Clear();

            {
                ...
                offset.Y = 5;
                offset.Angle = 0;
                offset.TextData = "LeftTop";
                arg.Offsets.Add(offset);
            }
            {
                var offset = Offset.Zero;
                offset.X = 5;
